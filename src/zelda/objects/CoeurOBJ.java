...
public class CoeurOBJ extends ObjectZ {
	
	private Zelda game;
	
	
	public CoeurOBJ(Zelda game) {
        super();
		this.game = game;
		this.initResources();
		this.setActive(true);
	...
	public void setBow() {
		SpriteGroup coeurOBJSG = game.getQuest().getCoeurOBJSG();
		coeurOBJSG.add(this);
	...
	private void initResources() {
		BufferedImage sprite = game.getImage("res/sprites/Objects/ORH.gif");
